...
# GmGame.start(player1=aiPlayer2,player2=humanPlayer1,max_time_to_move=1000,showIntermediateMoves=True) # don't speciry an aiPlayer for Human vs Human games
